...
import Bikeslist from "./Bikestlist";
...
export default function Search(){
    ...
    return <div>
        ...
        <p style={{textAlign:"center"}}>Second Hand Bikes Sales</p>
        <form className="search">
            <select id="searchTerm1" name="place" onChange={(e)=>setcategory(e.target.value)} form="selectplaceform">
                <option value="Select-city">Select-Bikes</option>
            ...
            <input type="text" id="searchTerm" onChange={handleChange} placeholder="Search for Bikes eg.R-15" required/>
          ...
          {istrue ? <Bikeslist brand={answer} category={category}/>  :""}
